from baselines.MDM.eval.unconstrained.models.stgcn import STGCN
import pandas as pd
...
import numpy as np
import sys as _sys
from baselines.MDM.eval.a2m.action2motion.fid import calculate_fid
from baselines.MDM.eval.a2m.action2motion.diversity import calculate_diversity
from baselines.MDM.eval.unconstrained.metrics.kid import calculate_kid
from baselines.MDM.eval.unconstrained.metrics.precision_recall import precision_and_recall
...
def evaluate_unconstrained_metrics(generated_motions, device, fast):
    ...
    act_rec_model_path = './checkpoints/actionrecognition/humanact12_gru_modi_struct.pth.tar'
