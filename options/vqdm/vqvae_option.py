...
def get_vqvae_args_parser():
    ...
    parser.add_argument('--lr_scheduler', default=[200000, 400000], nargs="+", type=int, help="learning rate schedule (iterations)")
    ...
    parser.add_argument('--exp_name', type=str, default='exp_debug', help='name of the experiment, will create a file inside out-dir')
    ## other
    ...
    args.lr_scheduler = [int(args.total_iter * 0.8)]
