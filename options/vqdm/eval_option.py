...
def get_eval_args_parser():
    ...
    ## evaluation
    parser.add_argument('--exp_name', type=str, required=True, help='name of the experiment, will create a file inside out-dir')
    parser.add_argument('--denoiser_pth', type=str, default='net_best_acc.pth')
    parser.add_argument("--vqvae_pth", type=str, default='vqvae.pth', help='resume pth for denoiser')
